...
:::{trust-claim}
:claim-id: clm_59fcf8eb1e5ff095
:claim: A probability-bounds economic model combining published irreproducibility estimates with United States life-science spending puts the cumulative preclinical irreproducibility rate at a midpoint of 53.3%, implying roughly US\$28 billion per year of non-reproducible preclinical research in the United States alone.
:cites: Freedman2015
...
:::{trust-claim}
:claim-id: clm_44f5be0d61757bdc
:claim: That figure has been restated by the group that produced it and folded into wider estimates ranging from US\$28 billion nationally to over US\$200 billion worldwide.
:cites: Freedman2017, Fitzpatrick2018
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_daff8f98969983c6
:claim: It sits within a broader accounting of avoidable waste in an enterprise that consumed some US\$240 billion globally in 2010 and close to a quarter of a trillion dollars annually thereafter, of which an oft-quoted 85% is judged to be squandered, and around which a consensus of meta-researchers holds that most new biomedical discoveries will not stand the test of time.
:cites: Chalmers2014, Moher2016, Ioannidis2014c, Begley2015, vonNiederhausern2018
:claim-type: review_synthesis
:modality: suggestive
:::

:::{trust-claim}
:claim-id: clm_f88a8b2eb442ae7f
:claim: Their value is not their precision but their convergence with a theoretical prior — that under realistic assumptions about power, bias, and pre-study odds, a research claim in most fields is more likely false than true.
...
:::{trust-claim}
:claim-id: clm_b8e48ab2b210f0ff
:claim: In 525 publications spanning sixteen stroke interventions, only 2.2% reported no significant effect, and correcting for the resulting funnel-plot asymmetry reduced pooled efficacy from 31.2% to 23.8%, with roughly one in six experiments estimated to be missing.
:cites: Sena2010
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_43039aafb7f506d1
:claim: The pattern is not confined to stroke: across 4,445 datasets in 160 meta-analyses of six neurological conditions, the observed number of "positive" studies (1,719) vastly exceeded the number predicted by their statistical power (919), and only eight of the 160 meta-analyses were free of any excess-significance or small-study signal.
:cites: Tsilidis2013
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_48b5275ba9f6d320
:claim: Synthesising these strands, publication bias alone was judged to account for a third or more of the efficacy reported in systematic reviews of animal stroke studies.
:cites: vanderWorp2010
:claim-type: empirical
:modality: established
:::

:::{trust-claim}
:claim-id: clm_a300641ff2a120ed
:claim: Individual meta-analyses have since put quantities on the correction: an updated review of interleukin-1 receptor antagonist in stroke found apparent efficacy of 36.2% fall to 21.9% once around thirty theoretically missing studies were imputed; a synthesis of sunitinib tumour studies calculated a 45% overestimate of effect size with not a single experiment using blinded outcome assessment; and trim-and-fill corrections have imputed 316 missing studies in chemotherapy-induced neuropathy, nineteen in stroke biomaterials, and thirteen in spinal-cord-injury nutrition, with funnel-plot asymmetry signalling the same missing-study problem in antidepressant forced-swim, ginsenoside stroke and heparin brain-injury literatures alike.
:cites: McCann2016, Henderson2015, Currie2019, Bolan2019, MacIntoshSmith2023, Martins2025, Xie2015, Aiyede2022
:claim-type: review_synthesis
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_b3ea2e63a596e030
:claim: A meta-analysis of fifteen rodent stroke trials, for instance, reported that metformin significantly improved every one of eight outcomes, and a synthesis of the noble gas argon reported benefit on every acquired-brain-injury endpoint — precisely the pattern that the cross-intervention analyses attribute to selective publication rather than to genuine, uniform efficacy.
:cites: Fu2022, Liang2022, Sena2010
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_a7eb0355b4e95c33
:claim: Two preclinical traumatic-brain-injury syntheses reached opposite conclusions about their own literature: a network meta-analysis of anaesthetic neuroprotection found no evidence that effect sizes were exaggerated by selective publication, whereas a progesterone meta-analysis detected clear funnel-plot asymmetry indicating bias.
:cites: Archer2018, NasreNasser2022
:claim-type: comparative
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_622093c3978c1027
:claim: Whether a given corner of the literature is bias-free or merely under-examined is often unresolved, and the safest reading is that positivity is uninformative until publication bias has been formally tested — a step that little more than half of preclinical systematic reviews actually take.
:cites: Russell2022
:claim-type: methodological
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_d422ccc8064b9d47
:claim: Opinion surveys of laboratory-animal researchers put the published fraction low: staff at not-for-profit institutes estimated that only half of conducted animal experiments are published, and those in for-profit settings estimated just 10%.
:cites: terRiet2012
:claim-type: empirical
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_69bd130d4fb7c1a0
:claim: Empirical protocol-to-publication tracking is more optimistic, finding that around 70% of registered animal-study proposals eventually yield at least one publication, consistent with a retrospective analysis in which 65% of internally funded medical projects — 46% of them involving animals — produced a peer-reviewed paper.
:cites: Deutsch2021, Deutsch2020
:claim-type: empirical
:modality: contested
:::
...
:claim: Subjective surveys of researchers estimate that only ~50% of experiments are published, whereas empirical tracking of registered protocols to publication finds rates closer to 70%.
:cites: terRiet2012, Deutsch2021
:claim-type: comparative
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_6c3de0b92a3957e4
:claim: The disagreement is largely resolved by method — impressions of the file drawer are darker than the auditable record — but even the optimistic figure leaves roughly a third of animal experiments unpublished, and self-report data show that the studies most likely to reach print are the ones that produced a result.
:cites: Deutsch2021
:claim-type: review_synthesis
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_e068e79c06186fa4
:claim: Whichever estimate is correct, the consequence is a literature in which protocols, full reports, and datasets are available for only about half of all studies and are further pruned by selective reporting of methods and outcomes.
:cites: Chan2014
:claim-type: review_synthesis
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_c41a0b7adbdf2dd0
:claim: The timing of publication compounds the problem for animal work specifically: across 47 novel drugs, 87% of accessible animal efficacy studies appeared only after the first human trial had been published, and for 17% of the drugs no efficacy study was published before that trial at all — so the animal evidence, when it exists, frequently cannot have informed the decision to test in people.
:cites: Federico2014
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_f25a760f8ba96e71
:claim: The Reproducibility Project: Cancer Biology set out to repeat 193 experiments from 53 high-impact papers but completed only 50, because no paper described its protocol in enough detail to run without modification and data underlying the original effect sizes were public for just four of the 193 experiments; of those it did attempt, replication effect sizes were markedly smaller than the originals, and several planned replications were abandoned before yielding any outcome.
:cites: Errington2021a, Errington2021b, Errington2021c
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_f69e5387bae21951
:claim: That completion figure — only 26% of the planned experiments could be carried out at all — is a feasibility ceiling rather than a replication rate, and as such is distinct from, though it sits alongside, the earlier industry audits in which an estimated 25% (Bayer) and 11% (Amgen) of findings could be reproduced.
:cites: Errington2021b
:claim-type: comparative
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_3b13d89bfb966d91
:claim: The survey underpinning the ARRIVE guidelines found that only 59% of 271 animal papers stated their hypothesis and basic animal characteristics, while 87% did not report randomisation and 86% did not report blinding; a decade later, adherence remained inconsistent enough to prompt a slimmed-down "Essential 10", and a randomised controlled trial at a major journal showed that simply requesting a completed checklist at submission produced no manuscript that met every ARRIVE item.
:cites: Kilkenny2010, PercieduSert2020a, Hair2019
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_a1ca49b3c2903f66
:claim: Independent audits have repeatedly documented the same gaps: reporting of bias-reduction measures is limited across a random sample of life-science papers and is actually lower in high-impact journals; a cerebrovascular journal volume stated a primary hypothesis in only 30% of articles; animal papers in a critical-care journal justified their sample size in 10% of cases, randomised in 43%, and blinded in 23%, with a single paper reporting an effect size; plastic-surgery animal studies blinded outcome assessment in 21.4%; and surveys spanning India, Sri Lanka and large-animal stroke models confirm the shortfall is global rather than parochial.
:cites: Macleod2015, Vesterinen2010, Reynolds2020, Freshwater2015, Singh2020, Kringe2020
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_a96fad79a5992e49
:claim: Underpinning all of this is chronic low power: the average neuroscience study is badly underpowered, which both inflates the effect sizes that do reach significance and lowers the probability that a positive result is true, and across disciplines statistical power has persistently sat below 50% while only about 13% of trials report outcomes fully consistent with their pre-registered commitments.
:cites: Button2013, Munafo2017
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_b0fde5e0a933218b
:claim: That underpowering and unreported bias-control are not cosmetic is shown by the direct effect of design items on measured efficacy, quantified in: unblinded ischaemia induction and unblinded outcome assessment each add several percentage points of apparent benefit.
:cites: Crossley2008, Watzlawick2019
:claim-type: causal
:modality: established
:::

:::{trust-claim}
:claim-id: clm_824bebb39bd91ce4
:claim: Reformers have responded with a proliferation of instruments — the SYRCLE risk-of-bias tool adapted from Cochrane, the NINDS core reporting standards, planning-stage guidance, preregistration platforms, dozens of consolidated preclinical guideline documents offering scores of rigor recommendations, and formal frameworks for sample-size determination under the Reduction principle — yet more than twenty competing appraisal tools now exist, itself an obstacle to any standard judgement of quality.
:cites: Hooijmans2014, Landis2012, Smith2017, Bert2019, Henderson2013, Lapchak2012, Serdar2021, Mazoit2026, Ma2020
:claim-type: methodological
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_d4208ff8a79259e1
:claim: Where improvement has occurred it has been uneven: a nationwide comparison found randomisation reporting rose from 24.0% to 40.8% between 2009 and 2018 while conflict-of-interest disclosure jumped from 37.6% to 90.4%, but a survey of in-vivo researchers still found fewer than half claiming to use blinded outcome assessment, and a commentary across twenty recent preclinical reviews found that not one study scored above eight of ten on a standard quality scale, with a median of four.
:cites: Kousholt2022, Reichlin2016, Russell2022
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_031df9d722100d7d
:claim: The same low-quality signature recurs wherever it is measured, from ischaemic-preconditioning and renal-injury syntheses reporting sample-size calculations in 2% of studies, to gene-therapy, herbal, and stem-cell meta-analyses with median risk-of-bias scores of four to five out of ten, to pain, osteoporosis and glioma reviews whose universally positive effects rest on studies at high or unclear risk of bias.
:cites: Wever2015, Jonker2016, Cunningham2022, Lin2021, Lalu2016, Liddle2021, Soliman2021, Zhang2022, Jue2018, Antonic2013, Huerta2024, Scuteri2022, Koop2023, Mugan2025
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_11dae37bc5a839eb
:claim: The pattern is strikingly indifferent to therapeutic area: meta-analyses of neuroprotection in stroke, Parkinson's and Alzheimer's models, of sepsis and cardiomyopathy, of antidepressant and seizure paradigms, of stem-cell and exosome therapies for wounds, neuropathy and osteoarthritis, and even of zebrafish neurobehaviour all converge on the same reading — large, uniformly positive pooled effects resting on primary studies that failed to report the safeguards that would make those effects trustworthy.
:cites: Yang2025, Su2021, Zhu2019, Zhang2020, Modiri2025, Sharif2025, Zingarelli2019, Lopes2020, Hum2024, Ratajczak2024, Arida2021, Yue2024, Bailey2021, Lu2025, Xing2018, Yamaura2023, Deckers2019, Huang2024, Reis2023
:claim-type: review_synthesis
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_248516e1f3698d42
:claim: A meta-analysis of misconduct surveys found that about 2% of scientists confess to having fabricated or falsified data at least once, while up to a third admit other questionable research practices — and far higher fractions report such practices in colleagues.
:cites: Fanelli2009
:claim-type: empirical
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_0f35419e6a0dfde9
:claim: Asked about specific behaviours, 64% of ecologists and evolutionary biologists reported having failed to publish a non-significant result, 42% had collected more data after checking significance, and 51% had presented an unexpected finding as though predicted.
:cites: Fraser2018
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_214e69abf381777c
:claim: Whether these practices materially distort conclusions is contested: text-mining of the p-value distribution suggests p-hacking is common but weak relative to real effects, yet an automated analysis of nearly 58,000 psychology articles found the proportion of significant p-values per paper stuck at 69% across a decade of reform.
:cites: Head2015, Boschen2023
:claim-type: comparative
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_c610f5bf953c42aa
:claim: Among highly cited clinical studies, 16% were later contradicted and another 16% had initially overstated effects; even after refutation by randomised trials, half of the articles citing contradicted observational claims remained favourable; and citation-network analysis has shown how a belief unsupported by primary data can accumulate hundreds of thousands of supporting citation paths and thereby manufacture unfounded authority.
:cites: Ioannidis2005a, Tatsioni2007, Greenberg2009
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_7cb7b65a1e348f10
:claim: The corrective apparatus is itself compromised, with systematic reviews and meta-analyses now mass-produced and, in the judgement of one bibliometric survey, largely redundant, misleading, or conflicted, even as the preclinical literature expands faster than systematic review can track it.
:cites: IOANNIDIS2016, Nakagawa2017, BannachBrown2021
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_eefb9a9b6e60edd2
:claim: Coordinated replications of 100 psychology studies found that only 36% reached significance against 97% of the originals, with replication effect sizes about half the originals; parallel efforts reproduced 62% of social-science experiments in Nature and Science, 39% of a psychology sample after re-coding for context, and prediction markets estimated a median prior probability of only 9% that the tested hypotheses were true; the same low-reproducibility metrics have since been carried into ecology and evolution.
:cites: OpenScienceCollaboration2015, Camerer2018, VanBavel2016, Dreber2015, Fidler2017
:claim-type: empirical
:modality: likely
:::
...
:claim: The Reproducibility Project: Psychology reported that only ~36% of replications were statistically significant.
:cites: OpenScienceCollaboration2015
:claim-type: empirical
:modality: established
:::

:::{trust-claim}
:claim-id: clm_03ae035bc6eab4a6
:claim: A prominent reanalysis argued the project contained three statistical errors and that, corrected for sampling error and power, the data are actually consistent with high reproducibility.
:cites: Gilbert2016
:claim-type: methodological
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_01f2693ca87fe046
:claim: A Bayesian treatment of the same 36% rate reached the opposite conclusion, inferring publication bias so large that dozens of negative results were expected to have occurred before one was published.
:cites: Ingre2018
:claim-type: methodological
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_b0ee7b5d1b95ca82
:claim: The dispute is about how replication should be measured, not about the underlying data — and it has since been reframed by some as a productive "credibility revolution" rather than a failure.
:cites: Korbmacher2023, Amaral2019
:claim-type: review_synthesis
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_55e98f414da87a05
:claim: That reproducibility is contingent on power and design, rather than a fixed property of a field, is underscored by genetics: genome-wide significant variants replicated 85% of the time in well-powered biobank data — but only 58% for binary versus 95% for quantitative traits — whereas the earlier, underpowered candidate-gene era found robust replication persistently elusive.
:cites: OSullivan2021, Li2012
:claim-type: causal
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_1fb35490b38e01b6
:claim: Human cancer cell lines diversify in culture: across 27 strains of MCF7, only 35% of coding variants were shared by all strains, and drug responses differed markedly.
:cites: BenDavid2018
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_751e4830ac94e2aa
:claim: Misidentification remains endemic — under a mandatory authentication policy at one cancer journal, 5.2% of submitted human cell lines were misidentified, and a line sold commercially as rabbit endothelium proved on barcoding to be bovine.
:cites: Souren2022, Vicente2021
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_0a358cc0f01a1db4
:claim: Antibodies are worse still: more than 3.8 million "research-grade" antibodies are marketed with little validation against fewer than 500 highly validated clinical-grade reagents, so that inconsistent antibody performance is a first-order driver of irreproducibility that end-users must themselves control.
:cites: Sfanos2019, PillaiKastoori2020, Venkataraman2018
:claim-type: causal
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_473403c4d01c6552
:claim: In a landmark demonstration, inbred mouse strains tested simultaneously in three laboratories under rigorously equated apparatus and protocols still differed systematically in behaviour across sites; a single retest of a P<0.05 behavioural result reproduces only about 60% of the time; behavioural measures carry coefficients of variation two to three times those of clinical chemistry; and inbred strains accumulate genetic drift that changes their phenotype over time and place, compounded by strain-background effects on stem-cell and xenograft phenotype.
:cites: Crabbe1999, vandeLagemaat2017, Aigner2023, TAFT2006, Ortmann2020, Devlin2022
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_3a304347c8059b41
:claim: Husbandry variables normally treated as invisible turn out to move results: the time of day a microbiome sample is taken can change a study's conclusion more than the intervention does, something as basic as body temperature shifts stroke infarct size by dozens of percent, and bedding material, chow diet, and cage-level gut-flora heterogeneity each perturb metabolic and cancer models.
:cites: Allaband2024, deJonge2019, Islam2021, Knuth2024, Feng2025
:claim-type: causal
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_65200809c972db1d
:claim: The models themselves are often so heterogeneously constructed that few designs are ever reused, as a catalogue of nearly 4,000 rodent fatty-liver models made plain.
:cites: Im2021
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_c657aafc7eac0002
:claim: Male animals have dominated biomedical research, most severely in neuroscience where single-sex male studies once outnumbered female ones 5.5 to 1; a decade after this was quantified, both-sex inclusion had risen across nine disciplines but the proportion actually analysing data by sex had not, in eight of them, despite a US policy expecting sex to be treated as a biological variable.
:cites: Beery2011, Woitowich2020, Miller2016
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_81018eb990627d11
:claim: The usual justification — that females are intrinsically more variable — is unfounded: across 311 neuroscience studies female rats were no more variable than males, even without controlling for the oestrous cycle, yet male-only designs continue to distort conclusions in domains from morphine sensitisation to cough, and even a variable as basic as animal age is reported inconsistently.
:cites: Becker2016, Brandner2024, Plevkova2017, OLeary2022, Jackson2016
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_12e905ceb9b7b6cb
:claim: The clinical stakes are concrete: of ten prescription drugs withdrawn from the United States market between 1997 and 2001, eight caused greater harm to women than to men, a record that motivated sex-disaggregated reporting standards.
:cites: Heidari2016
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_c7b1a722f93b6bd9
:claim: The proposed response is deliberate heterogenisation of samples and conditions, on the reaction-norm view that standardisation buys internal precision at the cost of external validity.
:cites: Voelkl2020, Voelkl2021
:claim-type: methodological
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_86453844590a7d31
:claim: The standardisation-and-rigour school holds that reproducibility follows from rigour plus transparency — pre-specified analysis plans, tight control of variation, and active laboratory management, and that minimising nuisance variation reduces the number of animals required.
:cites: Samsa2019, Serdar2021
:claim-type: methodological
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_e49de68b0dda5c25
:claim: The heterogenisation school holds that rigorous standardisation is itself a cause of irreproducibility, because a result tuned to one laboratory's idiosyncratic conditions has no external validity.
:cites: Voelkl2021, Voelkl2018
:claim-type: causal
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_05eb56c6114ab555
:claim: The evidence is genuinely mixed: a Shank2 multicentre study found that rigorously harmonised protocols yielded highly replicable genotype and treatment effects across sites, which standardisation and heterogenisation advocates read in opposite ways.
:cites: ArroyoAraujo2019
:claim-type: empirical
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_1ce5399b2843cb41
:claim: A six-centre stroke trial of an anti-CD49d antibody — undertaken only after positive single-lab studies had already triggered a clinical trial — found benefit confined to small cortical infarcts and none in large lesions, exposing the model-dependence that single-lab work had missed; a ten-site pig myocardial-infarction network built on the same principles was explicitly created to counter the lack of rigour behind failed cardioprotection translation.
:cites: Llovera2015, Kleinbongard2024, Btker2018
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_dbbbc12c97bbf7a2
:claim: The multicentre design is no panacea, however: a preregistered, fully blinded three-site confirmatory trial of neuroprotectants for chemotherapy-induced neuropathy failed its primary objective when unexpected toxicity and tumour growth left it underpowered — evidence that distributed rigour exposes translational uncertainty rather than abolishing it.
:cites: Boehmerle2025
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_4f6073513385becf
:claim: In a direct comparison of six interventions with unambiguous clinical evidence, corticosteroids benefited animal head-injury models (pooled odds ratio 0.58) yet showed no benefit in patients, and a scoping review of 121 quantitative animal-to-human comparisons found published translational success rates spanning the entire range from 0% to 100%, with animal-human toxicity concordance of 71% across species but only 43% for rodents alone.
:cites: Perel2006, Leenaars2019b
:claim-type: comparative
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_2f8f3944e4a574aa
:claim: More broadly, reviews of predictive validity conclude that animal models are weak predictors of human drug safety and efficacy across therapeutic areas, a judgement borne out by case histories: Hedgehog-pathway inhibitors, once hoped to treat a quarter of human cancers, responded clinically in only two rare tumour types; of 101 highly promising basic-science findings, only five reached licensed clinical use two decades later; creatine, neuroprotective in Parkinson's models, showed no benefit in trials of nearly 2,000 patients; and umbilical-cord-blood therapy, significant across preclinical lung-injury outcomes, produced no reduction in the corresponding clinical endpoint.
:cites: VanNorman2019, McGonigle2014, AKHTAR2015, Curran2018, ContopoulosIoannidis2003, Attia2017, Purcell2024
:claim-type: review_synthesis
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_a889c9db52a473e0
:claim: Even models that faithfully reproduce a human phenotype need not be fit for drug development; conversely, some models achieve high external validity yet are still run without any standard protocol.
:cites: Cannon2023, Aquarius2023, Brown2016, Bansal2017
:claim-type: limitation
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_a5a45ec9b0591c62
:claim: External validity as a whole has advanced far less than internal-validity reporting, reviews routinely extrapolate preclinical results to patients without first appraising the animal studies' risk of bias, and translational failure is sometimes traceable to mismatches as mundane as clinical outcome instruments too blunt to capture the effects seen in animals, or to physics and dosimetry parameters that are left unreported in the majority of radiobiology papers and vary enough between institutions to require credentialing.
:cites: Ferreira2020, Rongen2015, Lamontagne2010, Stein2015, Draeger2020, Ashraf2024
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_b0859de3fd58897a
:claim: Alzheimer's disease is the emblematic case: more than 300 interventions have been reported effective in animal models, with essentially none translating.
:cites: Shineman2011, SukoffRizzo2020
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_e26876dfd3666985
:claim: Independent analyses converge on a likelihood of moving from first-in-human testing to approval of roughly 5–14%, as shows: about 14% industry-wide, falling to 5–7% in single oncology indications.
:cites: Schuhmacher2025, DiMasi2014, Dhillon2022, Luo2026, Wasylewski2020
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_35ac85942839e5c1
:claim: Older and modeled estimates sit in the same range or below it — one in 33 compounds in castration-resistant prostate cancer, an overall clinical success rate near 12% falling to 4% for Alzheimer's-type indications, and 14–32% for antibody therapeutics — and the roughly 90% attrition rate, attributed in part to species differences, is now cited as a rationale for the FDA Modernization Act 2.0's opening to non-animal methods.
:cites: Tenuta2013, Farid2020, Crescioli2024, Zushin2023
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_2fee41155e5a6f24
:claim: The case for those alternatives is sharpened by evidence that some animal assays are themselves poorly reproducible — the rabbit Draize irritation test reclassifies fewer than half of moderate irritants on retest — while human-cell systems can outperform them, as when a high-content screen of human hepatocytes predicted drug hepatotoxicity far more sensitively than conventional assays and three-dimensional human tissue models were built to the same end.
:cites: Raabe2024, OBrien2006, Tutty2025
:claim-type: comparative
:modality: likely
:::
