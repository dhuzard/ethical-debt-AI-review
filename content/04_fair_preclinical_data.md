...
:::{trust-claim}
:claim-id: clm_b80ec0ed83c8b4a8
:claim: The FAIR Principles frame good data management not as an end in itself but as the conduit to knowledge discovery and to downstream reuse by both humans and machines.
:cites: Wilkinson2016
...
:::{trust-claim}
:claim-id: clm_9a500f407596a13f
:claim: The principles have proved extraordinarily influential — a bibliometric analysis of 2,529 documents on data governance and open sharing found the FAIR paper to be the most-cited reference in the field — and they have spawned a substantial apparatus.
:cites: Qiu2025
...
:::{trust-claim}
:claim-id: clm_46c2d4ea5c825809
:claim: Abstract principles were translated into quantifiable metrics implemented in open-source assessment tools such as F-UJI; maturity models and crosswalks now let a repository score its own compliance across dimensions, and one such crosswalk of three established approaches found strong correlations in the discovery and accessibility dimensions.
:cites: Devaraju2021, Peng2022, Corcho2024
:claim-type: methodological
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_8f9fcdc21685a8b4
:claim: Yet the same tooling literature concedes that assessment instruments are often either too domain-specific or too generalist to return a concrete, interpretable FAIRness level, and machine-actionable metadata templates such as CEDAR were introduced precisely because the community-defined "rich metadata" the principles demand was rarely being supplied in practice.
:cites: AguilarGomez2023, Musen2022, Batista2022
...
:::{trust-claim}
:claim-id: clm_f1e9694b63fea172
:claim: A systematic review and individual-participant-data meta-analysis pooling 105 meta-research studies covering more than two million articles found that, between 2016 and 2021, roughly 8% of medical papers declared their data were publicly available while only about 2% actually shared them, with public code sharing below half a percent.
:cites: Hamilton2023
:claim-type: empirical
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_78b539b6cd07db19
:claim: An audit of biomedical papers found that only about 9% pledged public data availability and a mere 3% followed through on the pledge; a study of authors whose data-availability statements promised sharing found that, on request, only 6.8% actually provided the data; and a cross-sectional analysis of 306 oncology articles found that, of all those sampled, just one — 0.3% (1 of 306) — met the full FAIR assessment criteria on inspection.
:cites: MartinRodriguez2026, Gabelica2022, Hamilton2022
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_7a612ddbb0140991
:claim: Discipline-specific screens tell the same story: only 1.5% of 7,509 dental research articles shared data at all, and of 1,340 Spanish COVID-19 papers only 12.5% shared any data, with just 2.1% deposited in a repository.
:cites: Uribe2022, CerdaCosme2022
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_99fa89339cdec790
:claim: reported that publishing in a journal with a mandatory data-sharing policy was associated with nearly a tenfold increase in the odds of sharing (OR 9.5, 95% CI 3.26–30.85), which suggests enforcement works.
:cites: Hamilton2022
:claim-type: causal
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_72ba5f27396d3484
:claim: But found that authors who stated they would share on request complied at essentially the same low rate as authors who made no such statement, implying that a data-availability statement is, on its own, close to inert.
:cites: Gabelica2022
...
:::{trust-claim}
:claim-id: clm_a0992972ee9fff68
:claim: Persistent identifiers, the backbone of findability, remain under-used even where they exist: in one dataset-citation study fewer than 40% of references to two well-known datasets used the dataset's DOI, and materials-science journals largely omit persistent-identifier guidance for code, so the links that would let a machine locate underlying data are frequently missing.
:cites: Mayernik2017, Hormann2026
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_6405dab755531d78
:claim: Researcher and resource identifiers are similarly patchy — ORCID coverage differs substantially between institutions and data sources, and is not yet sufficient for automated reporting — with the consequence that data reuse cannot even be detected: applying a link-resolution framework to one university's outputs raised the availability of author names on dataset links from 2.4% to 89.2%, and only then could a handful of reuse cases be identified at all.
:cites: Schnieders2022, Vrabel2016, Khan2020
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_86d73ea0e2ba611f
:claim: Even large curated efforts to attach identifiers reach a minority of the record, matching only about 36% of taxonomic names to publications across three databases, while on-demand DOI minting is still being retrofitted onto repositories that lacked it.
:cites: Page2023, Grynoch2025
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_c28c90fb5fed5c6e
:claim: Accessibility is not uniform either: contrary to the assumption that a repository deposit makes data equally reachable to all, access to open-science resources varies by country through connectivity failures and outright blocking, the advanced services that make data usable depend on intrinsically limited computational resources that will be rationed rather than free, and community-owned "diamond" infrastructures are emerging in part because commercial routes leave many researchers without genuine access.
:cites: Shanahan2022, Bertelli2025, Guerra2026
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_bba58a80f795a50d
:claim: Yet an audit of NSF-funded projects that had filed data-management plans found that 76% received an overall data-sharing score of zero, and that when sharing did occur the data were often of questionable usability owing to access, documentation, and formatting problems.
:cites: VanTuyl2016
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_3724a884285141aa
:claim: Review-level syntheses hold that "FAIR data leads to improved data sharing in different scientific domains", treating the principles as a demonstrated remedy.
:cites: Inau2023
:claim-type: review_synthesis
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_82bb1f4c9cbfc5b9
:claim: Project-level audits find the opposite: sharing at both the project and article level "was not carried out in the majority of cases, and when sharing was accomplished, the shared data were often of questionable usability".
:cites: VanTuyl2016
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_1a871bda548dcf0b
:claim: A survey of materials-science journal data policies found that over 80% offered no guidance on persistent identifiers for code and that data sharing was typically optional rather than required, so the machinery of findability is frequently absent at the point of publication.
:cites: Hormann2026
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_29cf9768156d56c1
:claim: Where it is present it is expensive: NIH appears to allocate roughly 10% of a genomic consortium's total budget to its data coordinating centre, and structured elicitation in one clinical field enumerated 45 distinct barriers to implementing FAIR.
:cites: Speir2025, deGroot2024
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_38cce2afcea6e857
:claim: A systematic audit of omics studies in the Gene Expression Omnibus found that only 11.5% shared all of their important phenotype metadata while 37.9% shared less than 40%, with roughly a quarter of critical metadata omitted on average.
:cites: Huang2025b
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_2866c15afb7fe73d
:claim: Programmatic FAIR scoring of shared datasets returns strikingly low reusability sub-scores: a dental-research corpus returned a reported mean Reusability of about 2.4 out of 10, and an independent assessment of urban air-quality datasets using a different automated tool reported Reusable scores of only 2 to 3 out of 10, with Interoperability the weakest dimension.
:cites: Uribe2022, Syed2025
:claim-type: empirical
:modality: suggestive
:::

:::{trust-claim}
:claim-id: clm_c68492dfb28e19f6
:claim: Self-assessed FAIR maturity of two clinical databases mapped to a common data model reached only 15.5 and 12 out of 25, the gaps concentrated in globally unique identifiers and machine-readable metadata.
:cites: Puttmann2023
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_7fec0200b431d303
:claim: The downstream cost is illustrated concretely: in global-health data reuse, one analyst described spending some 80% of their time on cleaning and curation before any analysis could begin, and inconsistent metadata force researchers to spend over 40% of curation time on manual standardization.
:cites: Waithira2026, Verbitsky2024
:claim-type: empirical
:modality: suggestive
:::
...
:::{trust-claim}
:claim-id: clm_7cdb70a617cd9c53
:claim: The contrast is sharp within neuroimaging: a purpose-built FAIR archive organised around the enforced Brain Imaging Data Structure documents substantial realized reuse, with 165 downstream publications identified that reused its datasets.
:cites: Markiewicz2021, Poldrack2024
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_28e4a9ac935d999e
:claim: A cross-specialty meta-analysis finds actual public data availability at only ~2% across medicine, and a Gene Expression Omnibus audit finds most omics studies share badly incomplete metadata.
:cites: Hamilton2023, Huang2025b
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_4226fdd142acb1ca
:claim: Yet an archive built on an enforced community standard documents more than 150 reuse publications.
:cites: Markiewicz2021
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_ab8709d52701969a
:claim: MIAME for microarrays seeded a family of checklists — MIAPE for proteomics, and the MIBBI project that catalogued the proliferating standards and coordinated their development — and these are genuine achievements of community consensus.
:cites: Brazma2001, Taylor2007, Taylor2008
:claim-type: review_synthesis
:modality: established
:::

:::{trust-claim}
:claim-id: clm_91ea143f6fe061e1
:claim: But a fully specified checklist does not guarantee reusable data: the MIAPE Quant module defines the minimum information a quantitative proteomics dataset needs so that it can be critically re-analysed or its analysis workflow reproduced, yet an independent reprocessing found that applying the guidelines still yielded large discrepancies from the same deposited data — differing protein counts and differentially abundant sets (for example, 13,068 versus 4,923 proteins, and 108 versus 11 differentially expressed proteins) — the shared-but-not-reusable pattern in miniature.
:cites: MartinezBartolome2013, Vadadokhau2026
:claim-type: methodological
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_8a550b210dc46de7
:claim: Common data elements built on the same logic have likewise seen disappointingly low adoption and have not broadly solved interoperability, and community checklists remain, in the main, human-readable narratives rather than the machine-actionable models that verifiable reuse requires.
:cites: Kush2020, Batista2022
:claim-type: review_synthesis
:modality: established
:::

:::{trust-claim}
:claim-id: clm_c150da83fe05ed23
:claim: The same gap between a standard's promise and its semantic reach recurs at the level of metadata registries: the ISO/IEC 11179 model is presented as automatically conferring FAIR adherence across findability, interoperability, and reusability, yet a variable-level harmonisation effort across cardiovascular cohorts found that it supplies only a general registry framework and lacks the formal semantic relationships needed to align variables across studies.
:cites: Stotl2025, Gilani2025
:claim-type: methodological
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_d2bed32ff25670f4
:claim: The TRUST Principles frame repository trustworthiness as something to be earned and demonstrated through external assessment, yet a content analysis of 91 certified repositories concluded that, although hundreds of Trustworthy Digital Repositories are certified, there is no evidence that certification actually improves preservation, and an instrument applied to eight biomedical repositories found little explicit acknowledgment of open, FAIR, citable, or trustworthy principles even where the underlying practices were present.
:cites: Lin2020, Donaldson2020, Murphy2021
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_4930d8af41d7d7dc
:claim: Ontology developers argue that coordinated, logically well-formed ontologies deliver interoperable and accurate representations of biological reality, but audits of the resulting annotations are sobering.
:cites: Smith2007
:claim-type: review_synthesis
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_5a196c5559228836
:claim: An analysis of Gene Ontology molecular-function annotations estimated that 64% of UniProtKB proteins are incompletely annotated and that inconsistencies affect 83% of protein functions and at least 23% of proteins; most annotations are generated by automated electronic inference rather than expert curation, so the bulk of the record is broad and not experimentally verified; a single co-annotation quality-control system corrected over 380,000 inferred annotations traced to just 54 mapping errors; and even the curated reference plant genome had experimental or predicted localization for only 90% of the proteome in its best-covered aspect.
:cites: Faria2012, Buza2008, Wood2020, Reiser2024
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_7c4c4fd2a36ac57f
:claim: Cross-ontology audits find over 1,900 logical nonalignments between core biomedical ontologies.
:cites: Bada2008
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_4abc8ee88c1fc4d5
:claim: Manual curation and ontology mapping across 212,027 omics samples from 468 studies consolidated redundant information and increased the completeness of major attributes.
:cites: Long2026
:claim-type: empirical
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_68064118ceb60b7e
:claim: But an automated FAIRification of rare-disease electronic-health-record data across 24 German medical centres introduced 1,977 new completeness issues (1,988 data-quality issues in total, of which 68% were later resolved) relative to a direct export.
:cites: Tahar2026
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_4b3429eb6be95b94
:claim: Exchange standards leak as badly as models: in one single-institution study, biomarker data present in the source record were missing in 80–100% of downstream standardized extracts.
:cites: App2026
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_900419ef75203bb8
:claim: FAIR frames maximal findability, accessibility, and reuse by the community as the goal of good data management.
:cites: Wilkinson2016
:claim-type: definition
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_97cf287d1f673bb7
:claim: The CARE Principles for Indigenous Data Governance were developed to complement it: FAIR facilitates sharing, but Indigenous Data Sovereignty holds that data on Indigenous Peoples must be shared on those peoples' terms.
:cites: Carroll2022b
:claim-type: definition
:modality: established
:::
...
:::{trust-claim}
:claim-id: clm_79acc89d3f5ecc57
:claim: The CARE position is now well developed: Indigenous research sovereignty asserts self-determination over data generated from research activities, universities are being urged to operationalise collective Indigenous rights over data against default open-data models, and emerging equitable global-health frameworks explicitly reject a default "open" setting in favour of governed access.
:cites: Hudson2023, Garba2023, West2026, Mayor2026, Calac2026
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_b6e25bebf3352486
:claim: The stakes are concrete where reference resources under-represent populations — Aboriginal and Torres Strait Islander peoples, for instance, are largely absent from human reference genomes.
:cites: ClarkAdnyamathanha2024
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_d61fd203c186198a
:claim: Governance constraints of a different kind bind the ordinary case too: privacy regulation such as GDPR can directly contradict open-data mandates, and human genomic and biospecimen repositories frequently operate under managed rather than open access for exactly this reason.
:cites: Hassenstein2025, Heeney2017
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_356d764ddbbb85c5
:claim: One position holds that "it is not sustainable to keep accumulating and maintaining all datasets for rapid access, considering the monetary and ecological cost of maintaining repositories".
:cites: Pernet2023
...
:::{trust-claim}
:claim-id: clm_ebbc084ea0300b16
:claim: The counter-position holds that "these costs are outweighed by the benefits of making research more reproducible, impactful, and equitable by facilitating the reuse of precious research resources".
:cites: GarciaClosas2023
:claim-type: comparative
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_483c1f66c162c4c9
:claim: A survey of 118 palaeontological and Earth-science databases found that roughly 85% of community-curated databases have lifespans under fifteen years, with peaks in database loss tracking five-year funding cycles — decades of volunteered data at risk of disappearing.
:cites: Dowding2026
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_0acc1dab3542368c
:claim: On the benefit side, the incentive most often invoked — a citation advantage for open data — is real but modest and method-sensitive: a 122,000-publication analysis found that depositing data in a repository was associated with only a 4.3% citation advantage on average, and none for sharing code, whereas a synthetic-control study of a journal-level open-data mandate reported a much larger increase.
:cites: Colavizza2024, Zhang2021
:claim-type: comparative
:modality: contested
:::

:::{trust-claim}
:claim-id: clm_6824b7b7b4488f56
:claim: Realized reuse is also highly concentrated, with downloads focused on a small share of deposited datasets, so the average dataset returns little of the reuse dividend that justifies its retention.
:cites: Late2024
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_d2206d1ef62fe0b8
:claim: A scoping review of interventions to incentivise sharing screened over a thousand papers and identified only a modest set of tested levers; at a different level entirely — and outside the animal-data scope of this review — the motivations of the individuals whose data are shared, whether financial or altruistic, are a distinct determinant of participation that generic institutional incentives do not touch.
:cites: Woods2022, Schmeiss2026, Kim2026a
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_7dfefc334b5854a2
:claim: Universal open-raw-data mandates can themselves cause harm where they force qualitative or consent-sensitive material into an inappropriate mould.
:cites: Prosser2024
:claim-type: causal
:modality: contested
:::
...
:::{trust-claim}
:claim-id: clm_b9e4c2afdec0507c
:claim: The reporting standards that would make an in vivo experiment reusable are unevenly adopted: the zebrafish community has not widely adopted data or metadata standards, so husbandry, imaging, and toxicology reporting remain inconsistent and reproducibility suffers, and traumatic-brain-injury translation is dominated by unpublished "dark data" from small, heterogeneous studies that never enter a findable record.
:cites: Ngu2025, Hawkins2020
:claim-type: review_synthesis
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_248e40d3837465c2
:claim: Where exemplary practice exists it is the exception that proves the rule — a MIAPE-compliant proteomic study of salbutamol effects on rat muscle was published explicitly as a model of how in vivo data should be deposited.
:cites: Kenyani2011
:claim-type: methodological
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_a70e4d51795170f3
:claim: The research reagents on which animal studies depend are themselves poorly stewarded: manual curation could identify only 1,445 studies providing knockout-validated evidence for specific antibodies, a tiny fraction of those in use, and roughly 40% of antibodies cited in one literature remained non-findable, lacking persistent research-resource identifiers, until stock centres actively intervened.
:cites: Biddle2024, Piekniewska2025
:claim-type: empirical
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_4f14f523e998bdbf
:claim: Electronic laboratory notebooks are advocated across chemistry, computational drug discovery, and regulated bioanalysis as the route from analogue records to FAIR-aligned capture at source, and structured, template-driven capture demonstrably helps — an AI-assisted chemistry notebook with built-in structured documentation improved student adherence to good data practice, and ontology-based notebooks can capture and automatically validate complex instrument metadata that would otherwise be lost.
:cites: HerresPawlis2022, Schaduangrat2020, Zeng2011, Solle2020, Higgins2022, Nwafor2025, Kirchner2026
:claim-type: methodological
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_128edac99ed0fdb3
:claim: A study of user-defined metadata in an electronic laboratory notebook found that many users made little effort to add metadata even when the facility existed, endangering their own ability to recover data later.
:cites: Willoughby2014
:claim-type: empirical
:modality: likely
:::

:::{trust-claim}
:claim-id: clm_40ae00e5f511f91d
:claim: The templated ISA-model alternative generates structured metadata in parallel at each level of a project so that submission is guided rather than optional.
:cites: Petek2022
:claim-type: methodological
:modality: likely
:::
...
:::{trust-claim}
:claim-id: clm_b97b249e4ba43f84
:claim: Failure to share research biospecimens and data diverts funds into duplicate cohorts and deters reproducibility assessment; cancer heterogeneity means single centres cannot generate enough data for accurate models, which was part of the original motivation for FAIR in the first place.
:cites: Rush2024, Vesteghem2019
:claim-type: causal
:modality: likely
:::
