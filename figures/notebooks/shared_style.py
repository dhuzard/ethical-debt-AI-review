...
COLORS = {
    ...
    # ─── Ethical-Debt document palette (Okabe-Ito, colorblind-safe) ───
    # Shared semantic colors used across the review's data-welfare figures.
    'declared_nominal':  '#56B4E9',  # declared / stated / nominal values
    'actual_verified':   '#0072B2',  # actual / verified / usable values
    'fair_compliant':    '#004C6D',  # FAIR-compliant (darkest blue)
    'debt':              '#D55E00',  # data waste, loss, non-reproducibility (the debt)
    'repayment':         '#009E73',  # reduction achieved, reuse, gain (repayment)
    'conflict':          '#E69F00',  # conflicting / divergent estimates
    'secondary_cat':     '#CC79A7',  # secondary category (e.g. NAM / non-animal)
    'emphasis_fill':     '#F0E442',  # callout / emphasis fill (use sparingly)
    'neutral_baseline':  '#999999',  # baseline, reference line, context
    'ink':               '#222222',  # text, axes, primary rules
}
